...
public final class RailroadCrossingItemGroups {
    public static final ItemGroup RAILROAD_CROSSING_CORE = FabricItemGroupBuilder.build(new Identifier("rc_core", "common"), RailroadCrossingItems.EMITTER_CIRCUIT_ITEM::getDefaultStack);
}
